    ...
    <body>
        <div class="container_12">
            <div class="grid_12 header-repeat">
                <div id="branding">
                    ...
                    <div class="floatright">
                        <div class="floatleft">
                            <img src="resource/images/img-profile.jpg" title="Usuario: Alumno" />
                        </div>
                        <div class="floatleft marginleft10">
                            <ul class="inline-ul floatleft">
                                <li>Bienvenido Alumno</li>
                                <li><a href="#" id="buttonCredencialesAlumno" title="Boton Funcional">Credenciales</a></li>
            ...
            <div class="grid_12">
                <ul class="nav main">
                    <li class="ic-cursos">
                        <a href="?mod=alumRegistro">
                            <span>Registrarse a un curso</span>
                        </a> 
                    </li>
                    <li class="ic-cash">
                        <a href="?mod=alumPagos">
                            <span>Pagos Realizados</span>
                        </a>
                    </li>
                    <li class="ic-asignacion">
                        <a href="?mod=alumFicha">
                            <span>Ficha academica</span>
                        </a>
                    </li>
                    <li class="ic-nota">
                        <a href="?mod=alumNotas">
                            <span>Calificaciones por cursos</span>
                        </a>
                    </li>
