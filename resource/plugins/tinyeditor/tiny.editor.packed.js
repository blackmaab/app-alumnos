var TINY=TINY||{},T$=T$||function(i){
    return document.getElementById(i) /*DEFAULT*/
},T$$$=T$$$||function(){
...
TINY.editor=function(){
    ...
    c['underline']=[6,'Subrayada','a','underline'];
    c['strikethrough']=[7,'Tachado','a','strikethrough'];
    c['subscript']=[8,'Sub-Indice','a','subscript'];
    c['superscript']=[9,'Super-Indice','a','superscript'];
    c['orderedlist']=[10,'Insertar una lista ordenada','a','insertorderedlist'];
    c['unorderedlist']=[11,'Insertar una lista desordenada','a','insertunorderedlist'];
    c['outdent']=[12,'Anular Sangria','a','outdent'];
    c['indent']=[13,'Sangria','a','indent'];
    c['leftalign']=[14,'Alinear a la Izquierda','a','justifyleft'];
    c['centeralign']=[15,'Alinear al Centro','a','justifycenter'];
    c['rightalign']=[16,'Alinear a la Derecha','a','justifyright'];
    c['blockjustify']=[17,'Bloque Justificado','a','justifyfull'];
    c['undo']=[18,'Deshacer','a','undo'];
    c['redo']=[19,'Rehacer','a','redo'];
    c['image']=[20,'Insertar Imagen','i','insertimage','Enter Image URL:','http://'];
    c['hr']=[21,'Insertar Regla Horizontal','a','inserthorizontalrule'];
    c['link']=[22,'Insertar Enlace','i','createlink','Ingrese URL:','http://'];
    c['unlink']=[23,'Quitar Enlace','a','unlink'];
    ...
    function edit(n,obj){
        ...
        for(i;i<l;i++){
            ...
            if(id=='n'){
                ...
                sel.options[0]=new Option('Fuentes','');
                for(x;x<fl;x++){
                    var font=fonts[x];
                ...
                var sel=document.createElement('select'),styles=obj.styles||[['Estilos',''],['Parrafo','<p>'],['Encabezado 1','<h1>'],['Encabezado 2','<h2>'],['Encabezado 3','<h3>'],['Encabezado 4','<h4>'],['Encabezado 5','<h5>'],['Encabezado 6','<h6>']],sl=styles.length,x=0;
        ...
        if(obj.footer){
            ...
            if(obj.toggle){
                ...
                ts.innerHTML=obj.toggletext||'Ver HTML';
    ...
    edit.prototype.toggle=function(post,div){
        if(!this.d){
            var v=this.t.value;
            if(div){
                div.innerHTML=this.obj.toggletext||'Ver HTML'
            }
            ...
            if(div){
                div.innerHTML=this.obj.toggletext||'Ocultar HTML'
            }
            this.t.value=v;
            if(!post){
